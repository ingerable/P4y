...
On remarque qu'avec un filtre médian plus grand on arrive à supprimer plus de bruit.
...
Le filtre gaussien n'est pas très efficace, en particulier pour le bruit gaussien.
